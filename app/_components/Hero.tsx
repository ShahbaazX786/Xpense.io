            ...
            <div className="mx-auto w-full px-4 lg:flex min-h-[400px] md:h-auto lg:h-auto flex justify-center items-center">
                <div className="flex flex-col gap-2 text-center justify-center items-center p-28">
                    ...
                    <div className="mt-8 flex flex-wrap justify-center gap-4">
                        <Link className="block w-full rounded bg-primary px-12 py-5 text-md font-medium text-white shadow hover:bg-blue-700 focus:outline-none focus:ring active:bg-blue-800 sm:w-auto" href="/sign-up"> Get Started Now! </Link>
                    </div>
                </div>
            </div>
            <Newsletter />
